...
override PKGDIR = xconfig_TM4C_Receiver
...
ti.targets.arm.elf.M4F.rootDir ?= C:/ti/ccsv8/tools/compiler/ti-cgt-arm_16.12.0.STS
...
package/%.xdc.inc package/%_xconfig_TM4C_Receiver.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_TM4C_Receiver" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: TM4C_Receiver.pem4f

-include package/cfg/TM4C_Receiver_pem4f.mak
-include package/cfg/TM4C_Receiver_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/TM4C_Receiver_pem4f.dep
endif
TM4C_Receiver.pem4f: package/cfg/TM4C_Receiver_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
TM4C_Receiver.pem4f package/cfg/TM4C_Receiver_pem4f.c: .libraries,em4f
endif

package/cfg/TM4C_Receiver_pem4f.c package/cfg/TM4C_Receiver_pem4f.h package/cfg/TM4C_Receiver_pem4f.xdl: override _PROG_NAME := TM4C_Receiver.xem4f
package/cfg/TM4C_Receiver_pem4f.c: package/cfg/TM4C_Receiver_pem4f.cfg
package/cfg/TM4C_Receiver_pem4f.xdc.inc: package/cfg/TM4C_Receiver_pem4f.xdl
package/cfg/TM4C_Receiver_pem4f.xdl package/cfg/TM4C_Receiver_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/TM4C_Receiver_pem4f.cfg
	-$(RM) package/cfg/TM4C_Receiver_pem4f.dep
	-$(RM) package/cfg/TM4C_Receiver_pem4f.c
	-$(RM) package/cfg/TM4C_Receiver_pem4f.xdc.inc

clean,em4f::
	-$(RM) TM4C_Receiver.pem4f
.executables,em4f .executables: TM4C_Receiver.xem4f

TM4C_Receiver.xem4f: |TM4C_Receiver.pem4f

-include package/cfg/TM4C_Receiver.xem4f.mak
TM4C_Receiver.xem4f: package/cfg/TM4C_Receiver_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/TM4C_Receiver_pem4f.oem4f   package/cfg/TM4C_Receiver_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
TM4C_Receiver.xem4f: export C_DIR=
TM4C_Receiver.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
TM4C_Receiver.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

TM4C_Receiver.test test,em4f test: TM4C_Receiver.xem4f.test

TM4C_Receiver.xem4f.test:: TM4C_Receiver.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 TM4C_Receiver.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.TM4C_Receiver.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,TM4C_Receiver.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) TM4C_Receiver.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
TM4C_Receiver_pem4f.oem4f,copy : package/cfg/TM4C_Receiver_pem4f.oem4f
TM4C_Receiver_pem4f.sem4f,copy : package/cfg/TM4C_Receiver_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_TM4C_Receiver
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_TM4C_Receiver.tar.dep
endif
package/rel/xconfig_TM4C_Receiver/xconfig_TM4C_Receiver/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_TM4C_Receiver/xconfig_TM4C_Receiver/package/package.rel.xml: package/build.cfg
package/rel/xconfig_TM4C_Receiver/xconfig_TM4C_Receiver/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_TM4C_Receiver/xconfig_TM4C_Receiver/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_TM4C_Receiver.tar: package/rel/xconfig_TM4C_Receiver.xdc.inc package/rel/xconfig_TM4C_Receiver/xconfig_TM4C_Receiver/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_TM4C_Receiver.xdc.inc,package/rel/xconfig_TM4C_Receiver.tar.dep)


release release,xconfig_TM4C_Receiver: all xconfig_TM4C_Receiver.tar
clean:: .clean
	-$(RM) xconfig_TM4C_Receiver.tar
	-$(RM) package/rel/xconfig_TM4C_Receiver.xdc.inc
	-$(RM) package/rel/xconfig_TM4C_Receiver.tar.dep
